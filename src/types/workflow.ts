...
const test2 = {
  ...
  data: {
    input:
      "Using Google Finance site, find 10 different company stocks one by one and compare them using the information u see on the page. Complete your workflow by giving a brief comparison between them using the graph on the page.",
    instances: 10,
    apiKey: "quark_h3w)^ssrwN94[XH;-+ZuyXF;9p",
    context: [],
    memory: true,
